        ...
        <div class="row">
            <div class="col-md-6" style="padding: 30px 145px 0;display: flex;flex-direction: column;">
                <div class="text-center">
                    <img class="img-fluid" :src="'/storage/Images/'+ chosenNumber.imgNum" alt="">
                </div>
                <div class="text-center" style="padding: 0 20px 0;font-size: 115px">
                    <p style="text-shadow: 0px 3px grey;" :style="{color: chosenNumber.color}">{{chosenNumber.nameEN}}</p>
                </div>
            </div>
            <div class="col-md-6" style="padding: 25px 137px 0">
                <div>
...
<script>
    export default {
        ...
        data(){
            return {
                numbers:[
                    {id:1, nameAR:'واحد',color:'#97D6E8',nameEN:'One',imgNum:'one.png',imgAnimate:'one-animate.png'},
                    {id:2, nameAR:'إثنان',color:'#F09F18',nameEN:'Two',imgNum:'two.png',imgAnimate:'two-animate.png'},
                    {id:3, nameAR:'ثلاثة',color:'#EE92B7',nameEN:'Three',imgNum:'three.png',imgAnimate:'three-animate.png'},
                    {id:4, nameAR:'أربعة',color:'#F2E652',nameEN:'Four',imgNum:'four.png',imgAnimate:'four-animate.png'},
                    {id:5, nameAR:'خمسة',color:'#9DBF63',nameEN:'Five',imgNum:'five.png',imgAnimate:'five-animate.png'},
                    {id:6, nameAR:'ستة',color:'#E21133',nameEN:'Six',imgNum:'six.png',imgAnimate:'six-animate.png'},
                    {id:7, nameAR:'سبعة',color:'#5D8BC3',nameEN:'Seven',imgNum:'seven.png',imgAnimate:'seven-animate.png'},
                    {id:8, nameAR:'ثمانية',color:'#BEBBDA',nameEN:'Eight',imgNum:'eight.png',imgAnimate:'eight-animate.png'},
                    {id:9, nameAR:'تسعة',color:'#93C6BF',nameEN:'Nine',imgNum:'nine.png',imgAnimate:'nine-animate.png'},
                    {id:10, nameAR:'عشرة',color:'#BF0826',nameEN:'Ten',imgNum:'ten.png',imgAnimate:'ten-animate.png'},
                ],
                chosenNumber:{},
                indexOfChosen:0
            }
