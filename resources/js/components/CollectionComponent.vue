    ...
    export default {
        ...
        created(){
            ...
            if (checkCollections === null) {
                let allData = [
                    { level: 1, open: true, href: "/pencilInBox",img:"pencilInBox.png",title:"Pencil in box"},
                    { level: 2, open: true, href: "/cards-2-2",img:"card2-2.png",title:"Card 2 * 2"},
                    { level: 3, open: true, href: "/cards-2-3",img:"card2-3.png",title:"Card 2 * 3" },
                    { level: 4, open: true, href: "/cards-3-4",img:"card4-3.png",title:"Card 4 * 3" },
                    { level: 5, open: true, href: "/cards-4-4",img:"card4-4.png",title:"Card 4 * 4" },
                ];
